package free.rm.skytube.player;
...
public class BackgroundPlayer extends Service {
    ...
    public static final String ACTION_CLOSE = "free.rm.skytube.player.BackgroundPlayer.CLOSE";
    public static final String ACTION_PLAY_PAUSE = "free.rm.skytube.player.BackgroundPlayer.PLAY_PAUSE";
    public static final String ACTION_OPEN_DETAIL = "free.rm.skytube.player.BackgroundPlayer.OPEN_DETAIL";
    public static final String ACTION_REPEAT = "free.rm.skytube.player.BackgroundPlayer.REPEAT";
    public static final String ACTION_FAST_REWIND = "free.rm.skytube.player.BackgroundPlayer.ACTION_FAST_REWIND";
    public static final String ACTION_FAST_FORWARD = "free.rm.skytube.player.BackgroundPlayer.ACTION_FAST_FORWARD";
    ...
    public long getCurrentPosition(){
        if(basePlayerImpl != null && basePlayerImpl.simpleExoPlayer != null)
            return basePlayerImpl.simpleExoPlayer.getCurrentPosition();
        else
            return 0;
    }
